...
export default {
  ...
  notes:
    "تم اضافه بعض المميزات البسيطه مثل عرض الرساله باكثر من لغه والتحقق من الاسم في بعض الحالات لليوم مثل وجود الهمزه في يوم الأحد علي سبيل المثال ربما يتم نسيانها من قبل المستخدم وقد تمت اضافه هذه التحققات بناءا علي تجربتي الخاصه وانها مشكله واجهتني",
  ...
  render: (container) => {
    ...
    const inputDay = InputComponent({
      type: "text",
      placeholder: "ادخل يومك المفضل",
      className:
